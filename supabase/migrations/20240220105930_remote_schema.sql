...
CREATE POLICY "all auth" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "all auth users" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
